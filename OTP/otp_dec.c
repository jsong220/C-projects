...
//Processes ciphertext and key text files to send message for decryption
	//for message relay, no decryption is done here
...
int main(int argc, char *argv[])
{
	...
	if (argc < 4) { fprintf(stderr,"USAGE: %s ciphertext mykey port\n", argv[0]); exit(0); } // Check usage & args
